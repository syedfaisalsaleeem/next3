...
export default function LatestCardHorn(){
                                ...
                                <Grid item xs={12} lg={9}>
                                    ...
                                    <Grid item  style={{background:"white",minWidth:"150px",minHeight:"79px",marginRight:"30px"}}>
                                        <div style={{display:"flex",flexDirection:"column",minWidth:"70px",minHeight:"79px",borderStyle:"solid",borderWidth:"0.1px",borderTop:"white",borderLeft:"white",borderBottom:"white"}} >
                                                ...
                                                <div style={{display:"flex",minWidth:"70px",minHeight:"40px",justifyContent:"center",alignItems:"center",fontSize:"14px"}} >
                                                ...
                                                <div container style={{display:"flex",fontSize:"18px",fontWeight:"600",minWidth:"70px",minHeight:"40px",justifyContent:"center",alignItems:"center",background:"#66BB6A",color:"white"}} >
                                                DD-MM-YYYY
                                                </div>
